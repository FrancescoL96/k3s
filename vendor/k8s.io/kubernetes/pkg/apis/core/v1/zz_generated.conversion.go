...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.RealTime)(nil), (*core.RealTime)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_RealTime_To_core_RealTime(a.(*v1.RealTime), b.(*core.RealTime), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.RealTime)(nil), (*v1.RealTime)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_RealTime_To_v1_RealTime(a.(*core.RealTime), b.(*v1.RealTime), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_Container_To_core_Container(in *v1.Container, out *core.Container, s conversion.Scope) error {
	...
	out.TTY = in.TTY
	if err := Convert_v1_RealTime_To_core_RealTime(&in.RealTime, &out.RealTime, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_core_Container_To_v1_Container(in *core.Container, out *v1.Container, s conversion.Scope) error {
	...
	out.StdinOnce = in.StdinOnce
	out.TTY = in.TTY
	if err := Convert_core_RealTime_To_v1_RealTime(&in.RealTime, &out.RealTime, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1_RealTime_To_core_RealTime(in *v1.RealTime, out *core.RealTime, s conversion.Scope) error {
	out.Criticality = in.Criticality
	out.RTDeadline = in.RTDeadline
	out.RTPeriod = in.RTPeriod
	out.RTWcet = in.RTWcet
	return nil
}

// Convert_v1_RealTime_To_core_RealTime is an autogenerated conversion function.
func Convert_v1_RealTime_To_core_RealTime(in *v1.RealTime, out *core.RealTime, s conversion.Scope) error {
	return autoConvert_v1_RealTime_To_core_RealTime(in, out, s)
}

func autoConvert_core_RealTime_To_v1_RealTime(in *core.RealTime, out *v1.RealTime, s conversion.Scope) error {
	out.Criticality = in.Criticality
	out.RTDeadline = in.RTDeadline
	out.RTPeriod = in.RTPeriod
	out.RTWcet = in.RTWcet
...
// Convert_core_RealTime_To_v1_RealTime is an autogenerated conversion function.
func Convert_core_RealTime_To_v1_RealTime(in *core.RealTime, out *v1.RealTime, s conversion.Scope) error {
	return autoConvert_core_RealTime_To_v1_RealTime(in, out, s)
}
